...
RUOTE_STORAGE = Ruote::MongoDbStorage.new(:config => 'config/ruote.yml',
...
unless $RAKE_TASK # don't register participants in rake tasks
  RuoteKit.engine.register do
    ...
    #participant 'staff_notification', Ruote::SmtpParticipant, {
    #  "server" => "mailhost.systemsbiology.net",
    #  "port" => 25,
    #  "to" => "Bruz.Marzolf@systemsbiology.org",
    #  "from" => "bmarzolf@frog.systemsbiology.net",
    #  "notification" => true,
    #  "template" => "Subject: Dashboard = ${f:message}"
    #}
    participant 'staff_notification', do |workitem|
      puts "Message: #{workitem.fields.inspect}"
    end
